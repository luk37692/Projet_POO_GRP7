...
private: System::Windows::Forms::Button^ OrdersManagment;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->OrdersManagment = (gcnew System::Windows::Forms::Button());
			this->AddressManagment = (gcnew System::Windows::Forms::Button());
			...
			// tabPage1
			// 
			this->tabPage1->Controls->Add(this->OrdersManagment);
			this->tabPage1->Controls->Add(this->AddressManagment);
			...
			// OrdersManagment
			// 
			resources->ApplyResources(this->OrdersManagment, L"OrdersManagment");
			this->OrdersManagment->Name = L"OrdersManagment";
			this->OrdersManagment->UseVisualStyleBackColor = true;
			this->OrdersManagment->Click += gcnew System::EventHandler(this, &MyForm::button2_Click);
			// 
			// AddressManagment
			// 
			resources->ApplyResources(this->AddressManagment, L"AddressManagment");
			this->AddressManagment->Name = L"AddressManagment";
			this->AddressManagment->UseVisualStyleBackColor = true;
			this->AddressManagment->Click += gcnew System::EventHandler(this, &MyForm::AddressManagment_Click);
			// 
			// dateTimePicker1
			// 
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	//Gestion commandes ouverture popup
	OrdersAddForm^ OrderForm = gcnew OrdersAddForm();
	OrderForm->getCustomer(customer_id);
